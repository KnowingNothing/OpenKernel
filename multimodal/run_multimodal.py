...
FIXED_SHAPES = {
    1001: (1, 12, 111, 128),      # 极短指令/对话
    1002: (4, 32, 599, 128),      # 标准 LLaVA 单图问答
    1003: (1, 20, 1023, 128),     # 1k 上下文边界测试
    1004: (1, 32, 2053, 128),     # 多图对比分析。
    1005: (2, 32, 1667, 128),     # 并发多图复杂任务
    1006: (1, 40, 4095, 128),     # 高清切图 OCR
    1007: (1, 32, 5123, 128),     # 短视频理解  
    1008: (1, 32, 7103, 128),     # 长文档/长视频
    1009: (16, 16, 127, 128),     # 投机采样验证/高吞吐
    1010: (1, 32, 8193, 128),     #8k 上下文溢出鲁棒性测试
}
